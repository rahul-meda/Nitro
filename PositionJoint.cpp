...
namespace Nitro
{
	...
	PositionJoint::PositionJoint(Body* A, Body* B)
		: Joint(A, B)
	{}
	...
	void PositionJoint::Solve()
	{
		...
		Jacobian J1(-x, -glm::cross(r1, x), x, glm::cross(r2, x));
		glm::vec3 y = glm::vec3(0, 1, 0);
		Jacobian J2(-y, -glm::cross(r1, y), y, glm::cross(r2, y));
		glm::vec3 z = glm::vec3(0, 0, 1);
		Jacobian J3(-z, -glm::cross(r1, z), z, glm::cross(r2, z));
